...
const styles = StyleSheet.create({
  ...
  sizeMd: { pad: { paddingVertical: 11, paddingHorizontal: 20 }, text: { fontSize: 13.5 } },
  sizeSm: { pad: { paddingVertical: 9, paddingHorizontal: 16 }, text: { fontSize: 12 } },
  sizeXs: { pad: { paddingVertical: 6, paddingHorizontal: 12 }, text: { fontSize: 11 } },
