...
const styles = StyleSheet.create({
  ...
  dayRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.6)', borderWidth: 1, borderColor: 'rgba(201,168,201,0.2)', borderRadius: radii.sm, paddingVertical: 8, paddingHorizontal: 12, marginBottom: 6 },
